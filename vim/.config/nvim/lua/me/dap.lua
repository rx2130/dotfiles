...
vim.keymap.set("n", "<leader>dr", function() dap.repl.toggle({ height = 15 }) end)
...
vim.keymap.set("v", "<leader>K", function() dapWidgets.hover(require("dap.utils").get_visual_selection_text) end)
