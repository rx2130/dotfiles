-- https://github.com/Hammerspoon/Spoons/raw/master/Spoons/ClipboardTool.spoon.zip
...
local myWatcher = hs.pathwatcher.new(os.getenv("HOME") .. "/dotfiles/init.lua", reloadConfig):start()
...
hs.hotkey.bind({ "cmd", "ctrl" }, "b", open("Books"))
hs.hotkey.bind({ "cmd", "ctrl" }, "t", open("Telegram"))
...
hs.hotkey.bind({ "cmd", "ctrl" }, "e", open("WeChat"))
